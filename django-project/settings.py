...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'pages.context_processors.get_page',
...
"""
#Toolbar button ckeditor. Si buscamos eso en internet, tenemos todas las opciones
#Le puedo modificar cosas desde aqui, como agregar otras cosas, etc
